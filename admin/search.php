    ...
    <div class="row-fluid">
      ...
      <div class="span9" id="content">
        <div class="row-fluid">
          ...
          <?php
          $count_student=mysql_query("select * from members where mobile LIKE '%$username%' ");
                ...
                <div class="span12">
                  <form action="" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                      ...
                      <tbody>
                        <?php
                        $search_query = mysql_query("select * from members	where mobile LIKE '%$username%'")or die(mysql_error());
