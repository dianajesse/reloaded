                ...
                <div class="row-fluid">
                  <div class="empty">
                    <div class="pull-right">
                      <a href="print_groupings.php" class="btn btn-info" id="print" data-placement="left" title="Click to Print"><i class="icon-print icon-large"></i> Print List</a>
                      <script type="text/javascript">
                      $(document).ready(function(){
                        $('#print').tooltip('show');
                        $('#print').tooltip('hide');
                  ...
                  <form action="" method="post">
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                      ...
                      <tbody>
                        ...
                        $members_querys = mysql_query("select * from members")or die(mysql_error());
                        while($row = mysql_fetch_array($members_querys)){
                          $username = $row['id'];
